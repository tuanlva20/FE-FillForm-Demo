        ...
        <DialogContent dividers>
          <Box sx={{ p: 1.5 }}>
            <Typography variant="body2">
              Bạn vui lòng chuyển khoản <b>chính xác nội dung chuyển tiền</b> bên dưới hệ thống sẽ tự động cộng tiền cho bạn sau 1 - 3 phút
            ...
            <Grid size={{ xs: 12, sm: 6 }}>
              <Stack spacing={2}>
                ...
                <Typography variant="h5" textAlign="center" color="primary">
                  ...
                  <IconButton size="small" onClick={() => handleCopyText(bankInfo.content, 'nội dung')}>
                    <Copy fontSize="small" />
                  </IconButton>
                </Typography>
                  ...
                  <Stack spacing={2}>
                    ...
                    <Stack direction="row" justifyContent="space-between" alignItems="center">
                      ...
                      <Stack direction="row" alignItems="center" spacing={1}>
                        ...
                        <IconButton size="small" onClick={() => handleCopyText(bankInfo.accountNumber, 'số tài khoản')}>
                          <Copy fontSize="small" />
                        </IconButton>
                      </Stack>
                    </Stack>
          ...
          <Box sx={{ mt: 3 }}>
            ...
            <Stack spacing={1} sx={{ ml: 2 }}>
              ...
              <Typography variant="body2">
                • Nạp tối thiểu: 10.000 đ. Có tính nạp dưới mức tối thiểu sai có phép không hỗ trợ dưới mọi hình thức.
              </Typography>
              <Typography variant="body2">• Nạp tiền sai có phép vui lòng liên hệ hỗ trợ để được hỗ trợ.</Typography>
              <Typography variant="body2">
                • Chỉ hỗ trợ các giao dịch nạp tiền sai có phép trong vòng 30 ngày kể từ ngày chuyển tiền, quá 30 ngày KHÔNG XỬ LÝ dưới mọi
                hình thức!
              </Typography>
              <Typography variant="body2">
                • Nên chuyển tiền nhanh 24/7 để được cộng tiền ngay sau khi ngân hàng xử lý giao dịch.
              </Typography>
