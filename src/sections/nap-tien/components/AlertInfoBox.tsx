...
export default function AlertInfoBox() {
  return (
    <Alert severity="warning" sx={{ color: 'black', border: '1px solid #e0e0e0', fontSize: 16 }}>
      <Typography component="span">
        Bạn vui lòng chuyển khoản <b>chính xác nội dung chuyển tiền</b> bên dưới hệ thống sẽ tự động cộng tiền cho bạn sau 1 - 3 phút sau
        khi nhận được tiền.
        <br />
